 ...
 * @endcode
 */
$settings['hash_salt'] = '6-tpLpAXBajs_L-0DD0ekirN7oYBIxoJt6vWwSv3z6b9lrvtjtbQcbBNHjp7LHWU6meQ1l40_Q';
 ...
 */
$settings['trusted_host_patterns'] = [
  '^www\.macdon-dev.bwi\.red$',
  '\.bwi\.red$',
  '^www\.newmacdon.bwi\.red$',
  '^172\.0.\0.\1$',
  '^localhost$',
];
/**
...
$settings['config_sync_directory'] = 'sites/default/files/jztnEG8_a3CJYsMAJTrej6PS5JrQ/sync';
